...
| $F$ | Faradays konstant | $96\,485$ | $\text{C/mol}$ |
| $k_B$ | Boltzmanns konstant | $1{,}381 \times 10^{-23}$ | $\text{J/K}$ |
| $h$ | Plancks konstant | $6{,}626 \times 10^{-34}$ | $\text{J}\cdot\text{s}$ |
| $e$ | Elementarladning | $1{,}602 \times 10^{-19}$ | $\text{C}$ |
| $c$ | Lysets fart (vakuum) | $2{,}998 \times 10^{8}$ | $\text{m/s}$ |
| $m_e$ | Elektronmasse | $9{,}109 \times 10^{-31}$ | $\text{kg}$ |
...
| $g$ | Tyngdeacceleration (Jorden) | $9{,}82$ | $\text{m/s}^2$ |
...
Faradays konstant er ladningen af ét mol elektroner:
